...
function App() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (response.data && response.data.visuallySimilarImages) {
        setImageUrls(response.data.visuallySimilarImages.map((image: any) => image.url));
      }
    } catch (error) {
      console.error(error);
    } finally {
